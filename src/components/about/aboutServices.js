...
export default function AboutServices() {
        return (
          <>
          <section className="bg-secondary md:px-[50px] py-20 flex">
            <div className="w-full mx-auto px-30 sm:flex sm:flex-col lg:px-30 flex flex-col justify-center">
              <h1 className="text-2xl mx-auto text-center sm:text-4xl font-light text-tranceblue mb-2 font-cinzel 
              ...
              <div className='sm:px-20 px-5 mx-auto'>
                <h3 className="font-bold font-cormorant-garamond text-tranceblue text-lg">Industrial and Residential Building</h3>
                <p className="text-sm sm:text-lg font-light text-tranceblue mb-5 font-cormorant-garamond">
              ...
              <div className='sm:px-20 px-5 mx-auto'>
                <h3 className="font-bold font-cormorant-garamond text-tranceblue text-lg">Infrastructure Building and Civil Work</h3>
                <p className="text-sm sm:text-lg font-light text-tranceblue mb-5 font-cormorant-garamond">
              ...
              <div className='sm:px-20 px-5 mx-auto'>
                <h3 className="font-bold font-cormorant-garamond text-tranceblue text-lg">Project Management</h3>
                <p className="text-sm sm:text-lg font-light text-tranceblue mb-5 font-cormorant-garamond">
              ...
              <div className='sm:px-20 px-5 mx-auto'>
                <h3 className="font-bold font-cormorant-garamond text-tranceblue text-lg">Engineering Procurement</h3>
                <p className="text-sm sm:text-lg font-light text-tranceblue mb-5 font-cormorant-garamond">
              ...
              <div className='sm:px-20 px-5 mx-auto'>
                <h3 className="font-bold font-cormorant-garamond text-tranceblue text-lg">Remodeling and Renovation</h3>
                <p className="text-sm sm:text-lg font-light text-tranceblue mb-5 font-cormorant-garamond">
              ...
              <div className='sm:px-20 px-5 mx-auto'>
                <h3 className="font-bold font-cormorant-garamond text-tranceblue text-lg">Sustainable Construction Solutions</h3>
                <p className="text-sm sm:text-lg font-light text-tranceblue mb-5 font-cormorant-garamond">
