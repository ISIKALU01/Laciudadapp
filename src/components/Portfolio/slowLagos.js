              ...
              bg-opacity-0 group-hover:bg-opacity-50 transition duration-300 ease-in-out">
                <div className="flex flex-col items-center">
                 ...
                 >
                  ...
                  <p className='text-secondary font-cormorant-garamond text-2xl font-bold'>Slow</p>
                  <p className='text-secondary font-cormorant-garamond text-xl'>Project year-2022</p>
