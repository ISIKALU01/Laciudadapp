...
const ConstructionMain = () => {
  return (
    ...
    <h1 className='font-cormorant-garamond font-light text-tranceblue text-2xl pt-[130px] text-center lg:px-[250px]'>The most important factors distinguishing La ciudad 
    ...
    <div className="flex justify-center items-center w-full h-auto px-[100px]">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 grid-rows-2 gap-[30px] sm:gap-[100px] sm:mt-[100px] mb-[50px]">
        ...
        <p className='text-md mt-[10px] text-center w-[200px] font-cormorant-garamond text-tranceblue'>Over 5-year Reputation for Honesty and Integrity</p>
        </div>
        <div className='flex flex-col justify-center items-center'>
        <div className="flex justify-center items-center w-[150px] h-[150px] bg-white rounded-full shadow-md hover:scale-110 transition-transform duration-300 cursor-pointer">
          <FaWrench className="text-[35px] text-primary" />
        </div>
        <p className='text-md mt-[10px] text-center w-[200px] font-cormorant-garamond text-tranceblue'>Diverse Professional
        ...
        <p className='text-md mt-[10px] text-center w-[100px] font-cormorant-garamond text-tranceblue'>Global presence</p>
        </div>    
        <div className='flex flex-col justify-center items-center'>
        <div className="flex justify-center items-center w-[150px] h-[150px] bg-white rounded-full shadow-md hover:scale-110 transition-transform duration-300 cursor-pointer">
          <FaChartLine  className="text-[35px] text-primary" />
        </div>
        <p className='text-md mt-[10px] text-center w-[200px] font-cormorant-garamond text-tranceblue'>Market Segment
         Expertise</p>
        </div>   
        <div className='flex flex-col justify-center items-center'>
        <div className="flex justify-center items-center w-[150px] h-[150px] bg-white rounded-full shadow-md hover:scale-110 transition-transform duration-300 cursor-pointer">
        ...
        <p className='text-md mt-[10px] text-center w-[200px] font-cormorant-garamond text-tranceblue'>Urban Site/Environment
        ...
        <p className='text-md mt-[10px] text-center w-[200px] font-cormorant-garamond text-tranceblue'>Supplier
         Diversity</p>
        </div> 
      </div>
    </div>
    ...
    <div className="w-full mx-auto px-10 sm:px-20 mt-[10px] sm:mt-[40px] sm:flex sm:flex-col lg:px-30 flex 
           flex-col justify-center pb-[50px]">
              <h1 className="text-1xl mx-auto text-center sm:text-[20px] md:text-[25px] font-light text-tranceblue mb-2 font-cinzel
               flex justify-center pb-1">LEADERS IN PLANNING, DESIGN AND CONSTRUCTION MANAGEMENT</h1> 
               <p className="mx-auto text-[12px] sm:text-[17px] font-light text-tranceblue mb-5 font-cormorant-garamond">
