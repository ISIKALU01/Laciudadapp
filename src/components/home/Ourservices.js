        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-0 relative">
          <div className="w-screen max-w-full h-80 sm:w-80 sm:h-80 m-0 p-0 relative group overflow-hidden cursor-pointer">
             <Image
              ...
              <span className='absolute w-full bottom-0 bg-primary text-center text-lg font-raleway text-white 
          ...
          <div className="w-screen max-w-full h-80 sm:w-80 sm:h-80 m-0 p-0 relative group overflow-hidden cursor-pointer">
             <Image
              ...
              <span className='absolute w-full bottom-0 bg-primary-200 text-center text-lg font-raleway 
              text-white py-6 px-10'>DEVELOPMENT</span>
              </Link>
          </div>
          <div className="w-screen max-w-full h-80 sm:w-80 sm:h-80 m-0 p-0 relative group overflow-hidden cursor-pointer">
              <Image
              ...
              <div className="absolute top-0 left-0 w-full bg-black/50 h-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 -translate-y-4 group-hover:translate-y-0">
                  <p className="text-white py-6 mt-4 font-raleway font-light px-5 text-sm -translate-y-4 group-hover:translate-y-0 transition-transform duration-500 ease-in-out">Our construction division offers a full range of construction
                  services, including general contracting, construction management agency, construction management at 
                  risk, and design-builds.</p>
              </div>
              <span className='absolute w-full bottom-0 bg-primary text-center text-lg font-raleway 
              text-white py-6 px-10'>PROJECT MANAGEMENT</span>
              </Link>
          </div>
        </div>
      </div>
