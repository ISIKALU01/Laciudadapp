        ...
        return (
          ...
          <section className="bg-secondary py-20 flex">
            <div className="w-full sm:text-center mx-auto px-10 sm:flex sm:flex-col sm:px-6 lg:px-20 flex flex-col justify-center">
              ...
              <p className="text-sm sm:text-lg font-light text-tranceblue mb-8 font-cinzel tracking-normal flex justify-center 
              text-center">
              ...
              <p className="text-sm sm:text-lg font-light text-tranceblue mb-9 font-cinzel tracking-normal flex 
